...
<body>
<?php
  if(isset($_GET['edited'])) echo "<div class=\"notif\">Department successfully edited.</div>";
?>
<div id="masthead">
...
<div id="content-wrapper">
  <div id="content2">
    ...
    <?php
      ...
      $sql = pg_query($conn, "SELECT * FROM department where id_no = '".$_GET['id']."'")or die("Query failed with error: ".pg_last_error($conn));
      $row = pg_fetch_array($sql);
      echo "
      <form action=\"editdepartment.php\" name=\"createdepartment\" method=\"post\" onSubmit=\"return validatedepartmentinfo();\" autocomplete=\"off\">
        <table>
          <tr>
