...
<body>
<?php
  if(isset($_GET['edited'])) echo "<div class=\"notif\">College successfully edited.</div>";
?>
<div id="masthead">
...
<div id="content-wrapper">
  <div id="content2">
    <h2>Edit an existing college record.</h2>
    <?php
      ...
      $sql = pg_query($conn, "SELECT * FROM college where id_no = '".$_GET['id']."'")or die("Query failed with error: ".pg_last_error($conn));
      $row = pg_fetch_array($sql);
      echo "
      <form action=\"editcollege.php\" name=\"createcollege\" method=\"post\" onSubmit=\"return validatecollegeinfo();\" autocomplete=\"off\">
        <table>
          <tr>
