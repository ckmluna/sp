...
<body>
<?php
  if(isset($_GET['invalid'])) echo "<div class=\"notif\">College name already taken.</div>";
  if(isset($_GET['added'])) echo "<div class=\"notif\">College successfully added.</div>";
?>
<div id="masthead">
...
<div id="content-wrapper">
  <div id="content2">
    <h2>Create a new college record.</h2>
    <form action="addcollege.php" name="createcollege" method="post" onSubmit="return validatecollegeinfo();" autocomplete="off">
      <table>
        <tr>
